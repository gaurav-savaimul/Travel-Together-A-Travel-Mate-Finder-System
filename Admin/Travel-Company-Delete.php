                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Travels Company Delete</h1>                            </div>
<?php        
		if(isset($_GET['id1']))
		{
		if($_GET['id1']=="done")
		{
		echo "<center><span style='color:red'><strong>Travel Company Deleted Succesfully!!</strong></span></center>";
		}
		if($_GET['id1']=="notdone")
		{
		...
		?>
        <a href="Travel-Dashboard.php" class="btn btn-primary" style="float:right;"> Back</a>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Delete Travel Company</h2>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="table-responsive" data-pattern="priority-columns">
                                          ...
                                          <th data-priority="1">Company name</th>
                                           <th data-priority="2">Owner age</th>
                                            <th data-priority="3">Establishment</th>
                                                       
                                                        <th data-priority="5">Contact</th>
                                                        
                                                     <th data-priority="5">Address</th>
                                                       <th data-priority="5">City</th>
                                                         <th data-priority="5">Pincode</th>
  ...
  $sql = $obj->db->prepare("select * from travel_company");
		...
		$sql->execute();
			...
			?> 
                                                    <tr>
                        <th><?php echo wordwrap($row['company_name'],15,'<br>'); ?></th>
                        ...
                        <td><a href="Travel-Company-Delete.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete</a></td>
...
$id=$_GET['id'];
$table="travel_company";
if($obj->delete($id,$table)==1)
{
	echo "<script>window.location='Travel-Company-Delete.php?id1=done';</script>";
}
