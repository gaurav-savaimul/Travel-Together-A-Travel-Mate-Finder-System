                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Approve Travel Company</h1>                            </div>
<?php        
		if(isset($_GET['id1']))
		{
		if($_GET['id1']=="done")
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Approve Travel Company  List</h2>
                                        ...
                                        <div class="table-responsive" data-pattern="priority-columns">
                                          ...
                                          <th data-priority="1">Company name</th>
                                           <th data-priority="2">Owner age</th>
                                            <th data-priority="3">Date of Establishment</th>
  ...
  $sql = $obj->db->prepare("select * from travel_company where approve='0' ORDER BY ID DESC");
		...
		$sql->execute();
			...
			?> 
                        ...
                        <td><a href="Travel-Company-Authenticate.php?id=<?php echo $row['ID']; ?>" class="btn btn-info">Approve</a></td>
...
{
	echo "<script>window.location='Travel-Company-Authenticate.php?id1=done';</script>";
}
