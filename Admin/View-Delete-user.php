                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Delete User</h1>                            </div>
<?php        
		if(isset($_GET['id1']))
		{
		if($_GET['id1']=="done")
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Delete User From List</h2>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-priority="3">Location</th>
                                                         <th data-priority="3">Email</th> <th data-priority="5">Pan No</th>
  ...
  $sql = $obj->db->prepare("select * from user");
		...
		$sql->execute();
			...
			?> 
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['email']; ?></td>  <td><?php echo $row['panno']; ?></td>
