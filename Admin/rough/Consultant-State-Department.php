                   ...
                   <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left"> Consultant State and Department</h2>
...
<form action="" method="POST" enctype="multipart/form-data"> 
    ...
    <label>Please Select State and Department</label><br><br>
 <input type="text" name="state" class="form-control" placeholder="Enter State" style="width:50%; float:left; margin-right:3%;">
 
 
  <br><br>
  <input type="text" name="department" placeholder="Enter Department" class="form-control" style="width:50%; float:left; margin-right:3%;">
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                 ...
                 <h3> Consultant Complete Details Submitted  Succesfully</h3>
...
if($obj->Consultant_state_department($id,$state,$department)==1)
{	
