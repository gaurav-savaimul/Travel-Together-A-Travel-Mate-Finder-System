...
<head>
    ...
    <body class=" "><!-- START TOPBAR -->
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Admin Logsheet and Forwarded Query </h1>                           
                                 </div>
		...
		if($_GET['id1']=="done")
		{
		echo "<center><span style='color:red'><strong>Listing Approved</strong></span></center>";
		}
		if($_GET['id1']=="notdone")
		{
...
<?php	
  ...
  $sql = $obj->db->prepare("select * from sub_admin ORDER BY ID DESC");
       ...
       <td><select>
       <option>View</option>
       <option value="">View Logsheet</option>
       <option value="">View Forwarded Query</option>
