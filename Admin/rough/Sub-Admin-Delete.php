                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Delete Subadmin </h1>                           
...
<?php        
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Approve Buyer's  List</h2>
  ...
  $sql = $obj->db->prepare("select * from sub_admin ORDER BY ID DESC");
      ...
      <td><a href="Sub-Admin-Delete.php?id=<?php echo $row['ID']; ?>" onclick="return confirm('Are you sure you want to delete this User?');" class="btn btn-info">Delete</a></td>
...
{
	echo "<script>window.location='Sub-Admin-Delete.php?id1=done';</script>";
}
}
?> 
