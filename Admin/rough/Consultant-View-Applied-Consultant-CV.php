...
<?php	
  ...
  $sql = $obj->db->prepare("select * from  consultant where approve='0' ORDER BY ID DESC");
       ...
       <td><a href="Consultant-View-Applied-Consultant-CV-Details.php?id=<?php echo $row['ID']; ?>" class="btn btn-primary">View Profile</a></td>
       <td><?php if($row['approve']=="0")
	   {echo "<strong style='color:#BABE14;'>Pending</strong>";} ?>
       <?php if($row['approve']=="2")
	   {echo "<strong style='color:#F00'>Rejected</strong>";} ?>
